...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 ...
 <%--   <p></p>
    ...
    <asp:Button ID="Fisika_Bab4" runat="server" Text="Complex Calculation" Height="56px" style="margin-left: 462px" Width="201px" />
     ...
     <p>
        <br />
        <asp:Button ID="Tambah_Soal_Fisika" runat="server" Text="Tambah_Soal_Pelajaran" Height="56px" style="margin-left: 462px" Width="201px" Visible="false" OnClick="Tambah_Soal_Eng_Click"/>
    </p>
</asp:Content>
